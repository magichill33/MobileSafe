...
public class QuestionHistoryReportActivity extends NormalBaseActivity implements
        OnClickListener {
    ...
    private HistoryReportBean historyReportBean = QuestionHistoryReportListActivity.bean;
    ...
    protected void installViews() {
        // TODO Auto-generated method stub
        setContentView(R.layout.activity_question_history_report);
        initTitleBar();
        initValues();
    ...
    protected void initTitleBar() {
        ...
        mTitleBar.centerTextView.setText(R.string.function_history_sb_i);
    ...
    private void readData() {
        ...
        for (int i = 0; i < historyReportBean.getList().size() / 2; i++) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put(LayoutStructure.from[0],
                    historyReportBean.getList().get(i * 2));
            map.put(LayoutStructure.from[1],
                    historyReportBean.getList().get(i * 2 + 1));
            data.add(map);
        }

        // 图片写入
        if (null != (imageList = historyReportBean.getApproveFileList())) {
