...
public class MenuInflater {
    ...
    private class MenuState {
         ...
         */
        private int itemShowAsAction;        private static final int defaultGroupId = NO_ID;
        private int itemActionViewLayout;        private static final int defaultItemId = NO_ID;
