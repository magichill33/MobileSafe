...
public class DiskLruCache {
     ...
     * {@link cn.ithm.kmplayer1.util.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
     ...
     * be called directly, call {@link cn.ithm.kmplayer1.util.DiskLruCache#clearCache(android.content.Context, String)}
     * or {@link cn.ithm.kmplayer1.util.DiskLruCache#clearCache()} instead.
     * 
     * @param cacheDir
     ...
     * {@link cn.ithm.kmplayer1.util.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
