package com.ly.cloudstorage.upload;
...
import com.ly.cloudstorage.bean.LocalFileDirInfo;
...
public class UploadFileExploerActivity extends SherlockActivity implements
	...
	private CloudEngine.ExploerLoadSdFileTask mExploerLoadSdFileTask;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(
				getString(R.string.local_file_label));
