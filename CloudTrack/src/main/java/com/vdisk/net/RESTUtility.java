...
/**
 * This class is mostly used internally by {@link com.vdisk.net.VDiskAPI} for creating and
...
public class RESTUtility {
	 ...
	 *         "en"}</code>.
	 * @param session
	 *            the {@link com.vdisk.net.session.Session} to use for this request.
	 *
	 ...
	 * @throws com.vdisk.net.exception.VDiskParseException
	 ...
	 * {@link com.vdisk.net.VDiskAPI.RequestAndResponse} containing the {@link org.apache.http.client.methods.HttpUriRequest} and
	 ...
	 *            the {@link com.vdisk.net.session.Session} to use for this request.
	 *
	 * @return returns a {@link com.vdisk.net.VDiskAPI.RequestAndResponse} containing the
	 *         {@link org.apache.http.client.methods.HttpUriRequest} and {@link org.apache.http.HttpResponse}.
	 *
	 * @throws com.vdisk.net.exception.VDiskServerException
	 *             if the server responds with an error code. See the constants
	 *             in {@link com.vdisk.net.exception.VDiskServerException} for the meaning of each error
	...
	/**
	 * Reads in content from an {@link org.apache.http.HttpResponse} and parses it as JSON.
	 *
	 * @param response
	 *            the {@link org.apache.http.HttpResponse}.
	 *
	 * @return a parsed JSON object, typically a Map or a JSONArray.
	 *
	 * @throws com.vdisk.net.exception.VDiskServerException
	 ...
	 *             from the {@link org.apache.http.HttpResponse}.
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if the user has revoked access.
	 * @throws com.vdisk.net.exception.VDiskParseException
	 *             if a malformed or unknown response was received from the
	...
	/**
	 * Reads in content from an {@link org.apache.http.HttpResponse} and parses it as a query
	 * string.
	 *
	 * @param response
	 *            the {@link org.apache.http.HttpResponse}.
	...
	/**
	 * Executes an {@link org.apache.http.client.methods.HttpUriRequest} with the given {@link com.vdisk.net.session.Session} and
	 * returns an {@link org.apache.http.HttpResponse}.
	 *
	 * @param session
	 *            the session to use.
	 * @param req
	 ...
	 *
	 * @return an {@link org.apache.http.HttpResponse}.
	 *
	 * @throws com.vdisk.net.exception.VDiskServerException
	 *             if the server responds with an error code. See the constants
	 *             in {@link com.vdisk.net.exception.VDiskServerException} for the meaning of each error
