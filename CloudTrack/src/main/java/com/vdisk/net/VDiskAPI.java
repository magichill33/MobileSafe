...
public class VDiskAPI<SESS_T extends Session> {
	...
	/**
	 * Returns the {@link com.vdisk.net.session.Session} that this API is using.
	 */
	 ...
	 *
	 * @throws com.vdisk.net.exception.VDiskException
	 */
	...
	/**
	 * Returns the {@link com.vdisk.net.VDiskAPI.Account} associated with the current {@link com.vdisk.net.session.Session}.
	 *
	 * @return the current session's {@link com.vdisk.net.VDiskAPI.Account}.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	 * @throws com.vdisk.net.exception.VDiskServerException
	 *             if the server responds with an error code. See the constants
	 *             in {@link com.vdisk.net.exception.VDiskServerException} for the meaning of each error
	 *             code.
	 * @throws com.vdisk.net.exception.VDiskIOException
	 ...
	 * {@link com.vdisk.net.VDiskAPI.VDiskFileInfo} for the file.
	 *
	 * @param path
	 ...
	 * @param os
	 *            the {@link java.io.OutputStream} to write the file to.
	 * @param listener
	 *            an optional {@link ProgressListener} to receive progress
	 *            updates as the file downloads, or null.
	 *
	 * @return the {@link com.vdisk.net.VDiskAPI.VDiskFileInfo} for the downloaded file.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	 ...
	 * @throws com.vdisk.net.exception.VDiskPartialFileException
	...
	/**
	 * Downloads a file from VDisk. Returns a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} via which
	 ...
	 * {@link com.vdisk.net.VDiskAPI.VDiskInputStream} at any time.
	 *
	 * @param path
	 *            the VDisk path to the file.
	 * @param rev
	 ...
	 *            download, or null to get the latest version.
	 *
	 * @return a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} from which to read the file contents.
	 ...
	 * @param is
	 *            the {@link java.io.InputStream} from which to upload.
	 * @param length
	 *            the amount of bytes to read from the {@link java.io.InputStream}.
	 * @param parentRev
	 ...
	 *
	 * @return a metadata {@link com.vdisk.net.VDiskAPI.Entry} representing the uploaded file.
	 *
	 ...
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	 * @throws com.vdisk.net.exception.VDiskFileSizeException
	 ...
	 *            progress updates, or null.
	 *
	 * @return an {@link com.vdisk.net.VDiskAPI.UploadRequest}.
	 *
	 * @throws IllegalArgumentException
	 *             if the file does not exist.
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 ...
	 *            metadata {@link com.vdisk.net.VDiskAPI.Entry}.
	 * @param parentRev
	 *            the rev of the file at which the user started editing it
	 *            (obtained from a metadata call), or null if this is a new
	 *            upload. If null, or if it does not match the latest rev on the
	 ...
	 * Returns the {@link com.vdisk.net.VDiskAPI.VDiskFileInfo} for the downloaded thumbnail.
	 *
	 * @param path
	 *            the VDisk path to the file for which you want to get a
	 *            thumbnail.
	 * @param os
	 *            the {@link java.io.OutputStream} to write the thumbnail to.
	 * @param size
	 ...
	 *
	 * @return the {@link com.vdisk.net.VDiskAPI.VDiskFileInfo} for the downloaded thumbnail.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	...
	/**
	 * Downloads a thumbnail from VDisk. Returns a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} via
	 ...
	 *            the image format of the thumbnail to download.
	 *
	 * @return a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} from which to read the thumbnail. The
	 ...
	 *            {@link com.vdisk.net.exception.VDiskServerException} will be thrown. Pass in null for
	 ...
	 *
	 * @return a metadata {@link com.vdisk.net.VDiskAPI.Entry}.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	 ...
	 *
	 * @return a metadata {@link com.vdisk.net.VDiskAPI.Entry} for the new folder.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	 ...
	 * time, but the metadata {@link com.vdisk.net.VDiskAPI.Entry}'s {@code isDeleted} attribute will
	 * be set to {@code true}.
	 *
	 * @param path
	 ...
	 *            call).
	 *
	 * @return a metadata {@link com.vdisk.net.VDiskAPI.Entry} for the newly restored file.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	...
	/**
	 * Returns a {@link com.vdisk.net.VDiskAPI.VDiskLink} for a stream of the given file path.
	 *
	 * @param path
	 ...
	 *
	 * @return a {@link com.vdisk.net.VDiskAPI.VDiskLink} for streaming the file.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	...
	/**
	 * Creates a request to upload an {@link java.io.InputStream} to a VDisk file. You
	 ...
	 * flexibility of uploading using an {@link java.io.InputStream}.
	 *
	 * @param path
	 *            the full VDisk path where to put the file, including
	 *            directories and filename.
	 ...
	 *            subsequent calls, pass in the {@link com.vdisk.net.VDiskAPI.DeltaPage#cursor cursor}
	 *            returned by the previous call.
	 *
	 * @return A single {@link com.vdisk.net.VDiskAPI.DeltaPage DeltaPage} of results. The
	 *         {@link com.vdisk.net.VDiskAPI.DeltaPage#hasMore hasMore} field will tell you whether the
	 ...
	 * {@link #createCopyRef createCopyRef()}. The {@link com.vdisk.net.VDiskAPI.CreatedCopyRef
	 ...
	 *            {@link com.vdisk.net.VDiskAPI.CreatedCopyRef#copyRef CreatedCopyRef.copyRef}, which
	 *            is created through {@link #createCopyRef createCopyRef()}).
	 * @param targetPath
	 *            The path that you want to create the file at.
	 *
	 * @return The {@link com.vdisk.net.VDiskAPI.Entry} for the new file.
	 *
	 * @throws com.vdisk.net.exception.VDiskUnlinkedException
	 *             if you have not set an access token pair on the session, or
	 *             if the user has revoked access.
	...
	/**
	 * Throws a {@link com.vdisk.net.exception.VDiskUnlinkedException} if the session in this instance
	 * is not linked.
	 */
	...
	public interface UploadRequest {
		 ...
		 * {@link com.vdisk.net.exception.VDiskPartialFileException}.
		 */
		public void abort();
		 ...
		 *
		 * @return an {@link com.vdisk.net.VDiskAPI.Entry} representing the uploaded file.
		 *
		 * @throws com.vdisk.net.exception.VDiskPartialFileException
		 *             if the request was canceled before completion.
		 * @throws com.vdisk.net.exception.VDiskServerException
		 *             if the server responds with an error code. See the
		 *             constants in {@link com.vdisk.net.exception.VDiskServerException} for the meaning
	...
	/**
	 * An {@link java.io.InputStream} for a file download that includes the associated
	 * {@link com.vdisk.net.VDiskAPI.VDiskFileInfo}. Closing this stream will cancel the associated
	 * download request.
	 */
	public static class VDiskInputStream extends FilterInputStream {
		...
		/**
		 * Returns the {@link com.vdisk.net.VDiskAPI.VDiskFileInfo} for the associated file.
		 */
		...
		/**
		 * Copies from a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} to an {@link java.io.OutputStream},
		 * optionally providing updates via a {@link ProgressListener}. You
		 * probably won't have a use for this function because most API
		 * functions that return a {@link com.vdisk.net.VDiskAPI.VDiskInputStream} have an alternate
		 * that will copy to an {@link java.io.OutputStream} for you.
		 *
		 * @param os
		 ...
		 * @throws com.vdisk.net.exception.VDiskLocalStorageFullException
	...
	/**
	 * Holds an {@link org.apache.http.client.methods.HttpUriRequest} and the associated {@link org.apache.http.HttpResponse}.
	 */
	...
	/**
	 * A page of {@link com.vdisk.net.VDiskAPI.DeltaEntry DeltaEntry}s (returned by {@link #delta
	 * delta}).
	 */
	...
	/**
	 * A single entry in a {@link com.vdisk.net.VDiskAPI.DeltaPage DeltaPage}.
	 */
